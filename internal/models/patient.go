...
type Patient struct {
	...
	LastNameTh   string    `gorm:"index:" json:"last_name_th" validate:"required,min=1,max=100"`
	...
	PatientHN    string    `gorm:"index" json:"patient_hn" validate:"required,min=1,max=50"`
